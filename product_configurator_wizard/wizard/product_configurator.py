...
class ProductConfigurator(models.TransientModel):
    ...
    def get_state_selection(self):
        ...
        open_lines = wiz.product_tmpl_id.get_open_step_lines(wiz.value_ids.ids)
    ...
    def get_form_vals(self, dynamic_fields, domains):
        ...
        product_img = self.product_tmpl_id.get_config_image_obj(dynamic_fields.values())
    ...
    def onchange(self, values, field_name, field_onchange):
        ...
        dynamic_fields = {
            k: v for k, v in values.iteritems() if k.startswith(self.field_prefix)
        }
    ...
    def fields_view_get(
        ...
        dynamic_fields = {
            ...
            if k.startswith(self.field_prefix) or k.startswith(self.custom_field_prefix)
        }
    ...
    def add_dynamic_fields(self, res, dynamic_fields, wiz):
        ...
        try:
            ...
            xml_dynamic_form = etree.Element("group", colspan="3", name="dynamic_form")
    ...
    def read(self, fields=None, load="_classic_read"):
        ...
        custom_attr_vals = [f for f in fields if f.startswith(self.custom_field_prefix)]
        ...
        for attr_line in self.product_tmpl_id.attribute_line_ids:
            ...
            vals = attr_line.value_ids.filtered(lambda v: v in self.value_ids)
            ...
            if attr_line.custom and custom_vals:
                ...
                if attr_line.attribute_id.custom_type == "binary":
                    dynamic_vals.update({custom_field_name: custom_vals.eval()})
                else:
                    dynamic_vals.update({custom_field_name: custom_vals.eval()})
    ...
    def _extra_line_values(self, so, product, new=True):
        ...
        if new:
            vals.update(
                {"name": product.display_name, "product_uom": product.uom_id.id,}
            )
        return vals
    ...
    def action_config_done(self):
        ...
        custom_vals = {
            ...
            for l in self.custom_value_ids
        }
