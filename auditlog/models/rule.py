...
class AuditlogRule(models.Model):
    ...
    log_read = fields.Boolean(
        u"Log Reads",
        help=(
            u"Select this if you want to keep track of read/open on any "
    ...
    log_write = fields.Boolean(
        ...
        default=True,
        help=(
            u"Select this if you want to keep track of modification on any "
            u"record of the model of this rule"
        ),
    )
    log_unlink = fields.Boolean(
        ...
        default=True,
        help=(
            u"Select this if you want to keep track of deletion on any "
            u"record of the model of this rule"
        ),
    )
    log_create = fields.Boolean(
        ...
        default=True,
        help=(
            u"Select this if you want to keep track of creation on any "
            u"record of the model of this rule"
        ),
    )
    log_type = fields.Selection(
        [("full", u"Full log"), ("fast", u"Fast log"),],
        string=u"Type",
        required=True,
        default="full",
        help=(
            u"Full log: make a diff between the data before and after "
