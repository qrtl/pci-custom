  ...
  tour.register(
    ...
    [
      ...
      },
      {
        ...
        run: function () {
          var radio = $("strong:contains('Automatic Sport (Steptronic)')")
            .parent()
            .parent()
            .siblings("label")
            .find("input");
      ...
      },
      {
        ...
        trigger:
          "#cfg_price_tags:has(div.label:contains('Transmission: Sport Automatic Transmission Steptronic'))",
        run: function () {
          var checkbox = $("strong:contains('Smoker Package')")
            .parent()
            .parent()
            .siblings("label")
            .find("input");
      ...
      },
      {
        ...
        run: function () {
          var checkbox = $("strong:contains('Tow hook')")
            .parent()
            .parent()
            .siblings("label")
            .find("input");
