...
def _website_price(self):
    ...
    group_price_subtotal = self.env.user.has_group('sale.group_show_price_subtotal')
    ret = group_price_subtotal and 'total_excluded' or 'total_included'
