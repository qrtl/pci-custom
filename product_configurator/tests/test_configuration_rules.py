...
class ConfigurationRules(TransactionCase):
    ...
    def test_invalid_configuration(self):
        ...
        self.assertFalse(
            validation,
            "Incompatible values (Diesel Fuel -> "
    ...
    def test_missing_val_configuration(self):
        ...
        self.assertFalse(
            validation,
            "Configuration with missing required " "values passed validation",
        )
    ...
    def test_invalid_multi_configuration(self):
        ...
        self.assertFalse(
            validation,
            "Configuration with multiple values for "
    ...
    def test_invalid_custom_value_configuration(self):
        ...
        attr_val_ids = self.get_attr_val_ids(conf)
        validation = self.cfg_tmpl.validate_configuration(attr_val_ids, custom_vals)

        self.assertFalse(
            validation, "Custom value accepted for fixed " "attribute color"
        )
